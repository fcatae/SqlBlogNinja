...
<P><A href="https://msdnshared.blob.core.windows.net/media/TNBlogsFS/BlogFileStorage/blogs_msdn/fcatae/WindowsLiveWriter/AmecnicadeumDiskDrive_14125/image_4.png"><IMG title="image" border="0" alt="image" src="https://msdnshared.blob.core.windows.net/media/TNBlogsFS/BlogFileStorage/blogs_msdn/fcatae/WindowsLiveWriter/AmecnicadeumDiskDrive_14125/image_thumb_1.png" width="402" height="221"></A> </P>
<P>Finalmente, cada track é dividido em vários setores - na grande maioria dos discos, cada setor possui 512 bytes.</P>
<P><A href="https://msdnshared.blob.core.windows.net/media/TNBlogsFS/BlogFileStorage/blogs_msdn/fcatae/WindowsLiveWriter/AmecnicadeumDiskDrive_14125/image_6.png"><IMG title="image" border="0" alt="image" src="https://msdnshared.blob.core.windows.net/media/TNBlogsFS/BlogFileStorage/blogs_msdn/fcatae/WindowsLiveWriter/AmecnicadeumDiskDrive_14125/image_thumb_2.png" width="350" height="207"></A> </P>
